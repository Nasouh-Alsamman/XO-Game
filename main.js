...
function proccess(num1,num2,num3){

    title.innerHTML=`${squers[num1]} Winner`;
    title.style.background='rgb(156, 0, 86, 705)';
    title.style.color='#fa0';

    document.getElementById('item'+num1).style.background='rgb(0, 33, 63)';
    document.getElementById('item'+num2).style.background='rgb(0, 33, 63)';
    document.getElementById('item'+num3).style.background='rgb(0, 33, 63)';
